...
//        };
            ...
            MimeMessagePreparator preparator = new MimeMessagePreparator() {
                ...
                public void prepare(MimeMessage mimeMessage) throws Exception {
                    ...
                    for(MultipartFile file : listMultipartFile){
                        listFile.add(new File(file.getOriginalFilename()));
    ...
    public void sendMailWithInlineResoruces(String from, String to, String subject, String body, List<MultipartFile> listMultipartFile) {
        List<File> listFile = new ArrayList<File>();
        try{
            MimeMessagePreparator preparator = new MimeMessagePreparator() {
                @Override
